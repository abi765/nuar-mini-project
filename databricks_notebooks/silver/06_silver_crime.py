...
# MAGIC %md
# MAGIC # Silver Layer - Crime Transformation
# MAGIC
# MAGIC **Converted from**: `notebooks/06_silver_crime.py`
# MAGIC
# MAGIC Transforms and enriches crime data with spatial information
...
print(f"💾 Output Location: nuar_catalog.silver.crime")
