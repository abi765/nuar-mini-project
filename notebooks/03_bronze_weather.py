"""
Bronze Layer: Weather Data Ingestion for Stockport
Collects current weather snapshot from OpenWeatherMap API
Run this regularly (daily/hourly) to build historical dataset
"""
