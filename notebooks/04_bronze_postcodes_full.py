"""
Bronze Layer: Postcode Data Ingestion for Stockport
Collects postcode data for all Stockport postcode areas (SK1-SK8)
"""
...
# Output directories
BRONZE_DIR = project_root / 'data' / 'bronze' / 'stockport' / 'postcodes'
